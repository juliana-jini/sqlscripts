...
-- 다음 insert 를 순서대로 실행할때 오류가 발생하는 것은?
...
-- 제약조건 4) check : 컬럼값의 범위를 설정 -> age컬럼값은 16~80 , null 허용합니다.
...
--		alter table ~ drop constraints 로 기존 제약조건 삭제해야 합니다.
