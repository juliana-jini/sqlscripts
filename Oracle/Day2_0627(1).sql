...
CREATE TABLE tbl_number(
	...
	col3 NUMBER (7,2),	-- 전체 최대 7자리 수, 소수점 이하 2자리 고정
	col4 NUMBER (2,5)	-- 소수점 이하 5자리 고정, 0이 아닌 유효숫자 최대 2자리
);
...
-- 0.00120 앞에 00은 유효한 0, 맨 마지막은 0은 불필요

-- 4) 저장된 값 : 0
INSERT INTO TBL_NUMBER VALUES (123456789, 1234, 12345, 0);	-- 0.00000
